        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    RequestFromId = table.Column<string>(type: "TEXT", nullable: true),
                    RequestToId = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friendships_AspNetUsers_RequestFromId",
                        column: x => x.RequestFromId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Friendships_AspNetUsers_RequestToId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendships_RequestFromId",
                table: "Friendships",
                column: "RequestFromId");

            migrationBuilder.CreateIndex(
                name: "IX_Friendships_RequestToId",
                table: "Friendships",
                column: "RequestToId");
